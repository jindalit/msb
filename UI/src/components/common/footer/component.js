                ...
                <div class="footer-inner">
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-md-8 col-sm-12">
                            <ul class="footer-nav">
                                <li class="nav-item">
                                    <Link to={role === 'User' ? "/" : "/admin"} className={"nav-link"} activeClassName='active' exact={true}>SERVICES HOME </Link>
                                </li>
                                <li class="nav-item">
                                    <Link to={role === 'User' ? "/safety" : "/admin/safety"} className={"nav-link"} activeClassName='active'>Safety</Link>
                                </li>
                                <li class="nav-item">
                                ...
                                {role !== 'User' ? <li class="nav-item">
                                    <Link className={"nav-link"} activeClassName='active' to='/viewHistory'>View History</Link>
                                </li> : ''}
                            </ul>
                        </div>
                    </div>
