                ...
                <div class="content-section">
                    ...
                    <div class="jobs-table new-report">
                        <div class="container">
                                ...
                                <table class="table table-striped job-table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <select name='equipmentId' value={this.state.formData.equipmentId} onChange={this.myChangeHandler}>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <select value={this.state.formData.severityId} name='severityId' onChange={this.myChangeHandler}>
                                                    {this.state.severity}
                                                </select>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <select value={this.state.formData.correctiveActionId} name='correctiveActionId' onChange={this.myChangeHandler}>
                                                    {this.state.actions}
                                                </select></td>
                                        </tr>
                            ...
                            <button class="btn btn-primary submit-button" onClick={this.formSubmit}>SUBMIT </button>
